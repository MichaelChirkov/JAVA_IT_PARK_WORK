    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            <div class="hero-unit">
                ...
                <br></br>
                Для того, чтобы начать обучение, выберите соответствующий раздел в меню слева. После прохождения темы каждой темы, рекомендуем проходить практические и теоретические тесты пройденного модуля.
            </div>
        </div><!--/row-->
    </div><!--/span-->
</div><!--/row-->
