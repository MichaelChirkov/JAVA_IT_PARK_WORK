    ...
    <div class="span6 offset3">
        <div class="hero-unit">
            <div align="center">
                ...
                <form action="/practic-tests" method="post">
                    <div class="alert alert-info" role="alert">После начала прохождения теста, ваш предыдущий результат по выбранному тесту будет сброшен.</div>
                    <!--<div class="form-group"> -->
                    <label for="sel1">Выберите тему для теста:</label>


                    <select class="form-control" id="sel1" name="select">
                        <option value="data_types">Типы данных</option>
                        <option value="variable_types">Типы переменных</option>
                        <option value="cycles_in_java">Циклы</option>
                        <option value="classes">Классы и объекты</option>
                    </select>
                    <p><button class="btn btn-small" type="submit">Приступить</button></p>
                    <!--  </div> -->
                </form>
