...
<div class="container-fluid">
    ...
    <div class="span12">
        <div class="hero-unit">
            <h1>Java Challenger</h1>
            <br></br>
            <p>Учебно-образовательный портал, на котором можно почитать информацию о языке программирования Java, отточить свои умения, проходя теоретические и практические тесты.</p>
