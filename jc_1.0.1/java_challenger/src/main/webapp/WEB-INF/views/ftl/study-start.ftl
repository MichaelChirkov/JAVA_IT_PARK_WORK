        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="active"><a href="/study">Учебные материалы</a></li>
    ...
    <div class="row-fluid">
        <div class="span3">
            <div class="well sidebar-nav">
                ...
                <!--    <li><a href="/data_types">Типы данных</a></li>
                    ...
                    <li><a href="/${theme.name}">${theme.ruName}</a></li>
        ...
        <div class="span9">
            <div class="hero-unit">
                ...
                <br></br>
                Для того, чтобы начать обучение, выберите соответствующий раздел в меню слева. После прохождения темы каждой темы, рекомендуется проходить практические и теоретические тесты по пройденной теме.
            </div>
        </div><!--/row-->
    </div><!--/span-->
</div><!--/row-->
