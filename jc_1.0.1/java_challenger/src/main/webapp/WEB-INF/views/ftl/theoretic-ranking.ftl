        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav">
                    ...
                    <li class="active"><a href=/theoretic-ranking>Рейтинг</a></li>
        ...
        <div class="span3">
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                    ...
                    <li class="active"><a href="/theoretic-ranking">Рейтинг по теории</a></li>
                    <li><a href="/practic-ranking">Рейтинг по практике</a></li>
                </ul>
            </div><!--/.well -->
        </div><!--/span-->
        <div class="span9">
            <div class="hero-unit">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>${user.totalTheoreticAnswersCount}
                        </td>
                    </tr>
                    </#list>
                    </tbody>
