        ...
        <div class="hero-unit">
            <div align="center">
                <font face="monospace"><h3><b><p>Поздравляем!</p> Вы прошли тест!</b></h3>
                    ...
                    <br>
                    Вы ответили правильно на <b><font color="#006400">${answer}</font></b>  из <b>${tasksCount}</b> заданий.
                    <p>Время прохождения теста: <b>${time}</b></p></font>

                <form action="/practic-tests" method="post">
                    <button class="btn" href="/practic-tests" formmethod="get">Пройти другой тест</button>
